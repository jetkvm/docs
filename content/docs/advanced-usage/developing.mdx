...
description: "JetKVM's developer features: Developer Mode for SSH access, DFU mode for firmware updates, and Serial Console for low-level debugging."
order: 2
---
...
1. Download the firmware update tool from [Factory Reset](/docs/advanced-usage/factory-reset)
